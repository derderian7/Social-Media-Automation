...
use App\Models\User;
use App\Notifications\failedPostsNotification;
use DateTime;
use DateTimeZone;
...
class PostsCronController extends Controller
{
    ...
    public static function update_facebook_post(Request $request, $id){
        ...
        if($fb_post->is_published == 0 && isset($data['cron_error_message']) && isset($data['is_published']) && $data['is_published'] == 2){
            ...
            Notification::send(Auth::user(),new failedPostsNotification($message));
        }
